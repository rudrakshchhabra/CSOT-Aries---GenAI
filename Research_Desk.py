...
# Using a stable, free model to prevent 404 errors
...
TOOLS = [
    {
        ...
        "function": {
            "name": "web_search",
            "description": "Search Google for live web information.",
            "parameters": {
                "type": "object",
                "properties": {
                    "query": {
    ...
    },
    {
        ...
        "function": {
            "name": "web_fetch",
            "description": "Download text from a specific URL.",
            "parameters": {
                "type": "object",
                "properties": {
                    "url": {
    ...
    },
    {
        ...
        "function": {
            "name": "paper_search",
            "description": "Search HuggingFace for ML/CS academic papers.",
            "parameters": {
                "type": "object",
                "properties": {
                    "query": {
    ...
    },
    {
        ...
        "function": {
            "name": "read_paper",
            "description": "Read the markdown content of an academic paper by ID.",
            "parameters": {
                "type": "object",
                "properties": {
                    "paper_id": {
...
def main():
    if len(sys.argv) > 1:
        if sys.argv[1] == "--tui":
            ...
            print(REPLAgent().run_once(prompt))
    else:
        REPLAgent().run()
